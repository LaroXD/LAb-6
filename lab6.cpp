...

{
    ...
    printf("Author: Lohit Aryan Gopikonda          \n");

    printf("Program: #6, Coin Swap     \n");

    printf("TA: Claude Shannon, Tuesday 3pm \n");
...
if(source<destination){
	if(board[destination]==' '&&destination==source+1)return false;
	if(board[destination]==' '&&destination==source+2&&board[source+1]=='O')return false;
}else return true;
}
if(board[source]=='O'){
if(source>destination){
	if(board[destination]==' '&&destination+1==source){cout<<source<<destination<<endl;return false;}
	if(board[destination]==' '&&destination==source-2&&board[source-1]=='X')return false;
}else return true;
}
}
else return true; 
